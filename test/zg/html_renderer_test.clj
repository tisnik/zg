...
(deftest test-render-navigation-bar-section-existence
  ...
  (testing
    "if the zg.html-renderer/render-navigation-bar-section definition exists."
...
(deftest test-render-html-header
  ...
  (testing
    "the function zg.html-renderer/render-html-header."
    (are [x y] (= (slurp x) y)
...
(deftest test-render-html-footer
  ...
  (testing "the function zg.html-renderer/render-html-footer."
           (is (= (slurp "test/expected/html_footer1.html")
                  (page/xhtml (render-html-footer))))))
...
(deftest test-render-search-href
  ...
  (testing
    "the function zg.html-renderer/render-search-href."
    (are [x y] (= (slurp x) y)
...
(deftest test-render-search-field
  ...
  (testing
    "the function zg.html-renderer/render-search-field."
    (are [x y] (= (slurp x) y)
...
(deftest test-render-name-field
  ...
  (testing
    "the function zg.html-renderer/render-name-field."
    (are [x y] (= (slurp x) y)
