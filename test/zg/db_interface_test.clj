...
(deftest test-insert-word-into-dictionary
    ...
    (testing "the function insert-word-into-dictionary."
        (with-redefs [jdbc/insert! (fn [db-spec table-name data-entry] table-name)]
            (are [x y] (= x y)
                :dictionary (insert-word-into-dictionary "word"           "description" "user-name"           :whitelist "2016-01-01")
                :dictionary (insert-word-into-dictionary "word"           "description" "user-name"           :blacklist "2016-01-01")
                :dictionary (insert-word-into-dictionary "different word" "description" "user-name"           :blacklist "2016-01-01")
                :dictionary (insert-word-into-dictionary "different word" "description" "user-name"           :blacklist "2016-01-01")
                :dictionary (insert-word-into-dictionary "different word" "description" "different user-name" :blacklist "2016-01-01")
                :dictionary (insert-word-into-dictionary "different word" "description" "different user-name" :blacklist "2016-01-01")))
        (with-redefs [jdbc/insert! (fn [db-spec table-name data-entry] (get data-entry :word))]
            (are [x y] (= x y)
                "word"           (insert-word-into-dictionary "word"           "description" "user-name"           :whitelist "2016-01-01")
                "word"           (insert-word-into-dictionary "word"           "description" "user-name"           :blacklist "2016-01-01")
                "different word" (insert-word-into-dictionary "different word" "description" "user-name"           :blacklist "2016-01-01")
                "different word" (insert-word-into-dictionary "different word" "description" "user-name"           :blacklist "2016-01-01")
                "different word" (insert-word-into-dictionary "different word" "description" "different user-name" :blacklist "2016-01-01")
                "different word" (insert-word-into-dictionary "different word" "description" "different user-name" :blacklist "2016-01-01")))
        (with-redefs [jdbc/insert! (fn [db-spec table-name data-entry] (get data-entry :dictionary))]
            (are [x y] (= x y)
                "w" (insert-word-into-dictionary "word"           "description" "user-name"           :whitelist "2016-01-01")
                "b" (insert-word-into-dictionary "word"           "description" "user-name"           :blacklist "2016-01-01")
                "b" (insert-word-into-dictionary "different word" "description" "user-name"           :blacklist "2016-01-01")
                "b" (insert-word-into-dictionary "different word" "description" "user-name"           :blacklist "2016-01-01")
                "b" (insert-word-into-dictionary "different word" "description" "different user-name" :blacklist "2016-01-01")
                "b" (insert-word-into-dictionary "different word" "description" "different user-name" :blacklist "2016-01-01")))))
