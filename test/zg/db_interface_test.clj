...
(deftest test-insert-word-into-dictionary-existence
  ...
  (testing
    "if the zg.db-interface/insert-word-into-dictionary definition exists."
...
(deftest test-add-new-word-into-dictionary-existence
  ...
  (testing
    "if the zg.db-interface/add-new-word-into-dictionary definition exists."
...
(deftest test-insert-word-into-dictionary
  ...
  (testing
    "the function insert-word-into-dictionary."
    (with-redefs [jdbc/insert! (fn [db-spec table-name data-entry] table-name)]
      (are [x y] (= x y)
           ...
           :dictionary (insert-word-into-dictionary "different word" nil "description" "different user-name" :blacklist "2016-01-01")
           :dictionary (insert-word-into-dictionary "word"           "correct form" "description" "user-name"           :whitelist "2016-01-01")
           :dictionary (insert-word-into-dictionary "word"           "correct form" "description" "user-name"           :blacklist "2016-01-01")
           :dictionary (insert-word-into-dictionary "different word" "correct form" "description" "user-name"           :blacklist "2016-01-01")
           :dictionary (insert-word-into-dictionary "different word" "correct form" "description" "user-name"           :blacklist "2016-01-01")
           :dictionary (insert-word-into-dictionary "different word" "correct form" "description" "different user-name" :blacklist "2016-01-01")
           :dictionary (insert-word-into-dictionary "different word" "correct form" "description" "different user-name" :blacklist "2016-01-01")))
    (with-redefs [jdbc/insert! (fn [db-spec table-name data-entry]
                                 (get data-entry :word))]
      (are [x y] (= x y)
           ...
           "different word" (insert-word-into-dictionary "different word" nil "description" "different user-name" :blacklist "2016-01-01")
           "word"           (insert-word-into-dictionary "word"           "correct form" "description" "user-name"           :whitelist "2016-01-01")
           "word"           (insert-word-into-dictionary "word"           "correct form" "description" "user-name"           :blacklist "2016-01-01")
           "different word" (insert-word-into-dictionary "different word" "correct form" "description" "user-name"           :blacklist "2016-01-01")
           "different word" (insert-word-into-dictionary "different word" "correct form" "description" "user-name"           :blacklist "2016-01-01")
           "different word" (insert-word-into-dictionary "different word" "correct form" "description" "different user-name" :blacklist "2016-01-01")
           "different word" (insert-word-into-dictionary "different word" "correct form" "description" "different user-name" :blacklist "2016-01-01")))
    (with-redefs [jdbc/insert! (fn [db-spec table-name data-entry]
                                 (get data-entry :dictionary))]
      (are [x y] (= x y)
           ...
           "b" (insert-word-into-dictionary "different word" nil "description" "different user-name" :blacklist "2016-01-01")
           "w" (insert-word-into-dictionary "word"           "correct form" "description" "user-name"           :whitelist "2016-01-01")
           "b" (insert-word-into-dictionary "word"           "correct form" "description" "user-name"           :blacklist "2016-01-01")
           "b" (insert-word-into-dictionary "different word" "correct form" "description" "user-name"           :blacklist "2016-01-01")
           "b" (insert-word-into-dictionary "different word" "correct form" "description" "user-name"           :blacklist "2016-01-01")
           "b" (insert-word-into-dictionary "different word" "correct form" "description" "different user-name" :blacklist "2016-01-01")
           "b" (insert-word-into-dictionary "different word" "correct form" "description" "different user-name" :blacklist "2016-01-01")))
    (with-redefs [jdbc/insert! (fn [db-spec table-name data-entry]
                                 (get data-entry :correct))]
      (are [x y] (= x y)
           nil (insert-word-into-dictionary "word"           nil "description" "user-name"           :whitelist "2016-01-01")
           nil (insert-word-into-dictionary "word"           nil "description" "user-name"           :blacklist "2016-01-01")
           nil (insert-word-into-dictionary "different word" nil "description" "user-name"           :blacklist "2016-01-01")
           nil (insert-word-into-dictionary "different word" nil "description" "user-name"           :blacklist "2016-01-01")
           nil (insert-word-into-dictionary "different word" nil "description" "different user-name" :blacklist "2016-01-01")
           nil (insert-word-into-dictionary "different word" nil "description" "different user-name" :blacklist "2016-01-01")
           "correct form" (insert-word-into-dictionary "word"           "correct form" "description" "user-name"           :whitelist "2016-01-01")
           "correct form" (insert-word-into-dictionary "word"           "correct form" "description" "user-name"           :blacklist "2016-01-01")
           "correct form" (insert-word-into-dictionary "different word" "correct form" "description" "user-name"           :blacklist "2016-01-01")
           "correct form" (insert-word-into-dictionary "different word" "correct form" "description" "user-name"           :blacklist "2016-01-01")
           "correct form" (insert-word-into-dictionary "different word" "correct form" "description" "different user-name" :blacklist "2016-01-01")
           "correct form" (insert-word-into-dictionary "different word" "correct form" "description" "different user-name" :blacklist "2016-01-01")))))
