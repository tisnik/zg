...
(defn store-word
    ...
    (log/info "About to store following word:" word " with description: " description " into dictionary: " (str dictionary-type))
    (db-interface/add-new-word-into-dictionary word description (process-class class) (process-use-it use-it) internal copyright (inc source) correct-forms incorrect-forms (or user-name "(*unknown*)") dictionary-type)))
